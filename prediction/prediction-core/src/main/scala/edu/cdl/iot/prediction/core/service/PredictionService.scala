package edu.cdl.iot.prediction.core.service
...
import edu.cdl.iot.prediction.core.repository.{PredictionProjectRepository, PredictionSensorDataRepository, PredictionSensorRepository}
